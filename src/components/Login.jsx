            ...
            <form onSubmit={handleLogin} className="space-y-12">
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" placeholder="Enter your password" className="w-full px-3 py-2 border rounded-md border-gray-300 bg-gray-50 text-gray-800" />
                    </div>
                </div>
